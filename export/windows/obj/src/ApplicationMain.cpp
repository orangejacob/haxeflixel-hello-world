...
HXLINE(  18)		::lime::_hx_system::System_obj::_hx___registerEntryPoint(HX_("HelloWorld",00,76,b5,bd),::ApplicationMain_obj::create_dyn());
...
HXLINE(  37)		app->meta->set(HX_("file",7c,ce,bb,43),HX_("HelloWorld",00,76,b5,bd));
HXLINE(  38)		app->meta->set(HX_("name",4b,72,ff,48),HX_("HelloWorld",00,76,b5,bd));
